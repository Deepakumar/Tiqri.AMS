var amc = angular.module('amc', ['ngResource', 'ui.router', 'LocalStorageModule','datatables']);
...
function configRoutes($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state('accident.registread', {
        url: '/registread',
        templateUrl: '/templates/accident_registread.html'
    });
